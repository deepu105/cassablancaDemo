...
public class CassablancaDemoApp {

    private static final Logger log = LoggerFactory.getLogger(CassablancaDemoApp.class);

    private final Environment env;

    public CassablancaDemoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes cassablancaDemo.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CassablancaDemoApp.class);
